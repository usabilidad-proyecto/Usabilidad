...
#if UNITY_EDITOR
            TrackerGr03.Tracker.sendTrace(new TrackerGr03.Tracker.Trace(UnityStats.screenRes, UnityStats.drawCalls, UnityStats.triangles, UnityStats.vertices, CountObjects(), 0.01f / UnityStats.renderTime));
#else
